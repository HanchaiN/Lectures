...
- Addition Reaction
 ...
 - Electrophilic Aromatic Substitution: $\ce{Ar-H + E+ -> Ar-E + H+}$
	 ...
	 - Electron Donating Group & Electron Withdrawing Groups
		 ...
		 1. $\pi$-donors (Negative Resonance + (weakly) Positive Inductive):  
		    $\ce{-NH2}, \ce{-NHR}, \ce{-NR2} > \ce{-OH} > \ce{-OR} > \ce{-NH-CO-R} > \ce{-O-CO-R}$
		 2. $\sigma$-donors (Negative Inductive):  
		    $\ce{-CH} > \ce{-R} > \ce{-Ar} > \ce{-H}$
		 3. Halogens (Negative Resonance + Positive Inductive):
			 - *o*-/*p*-directing (have electron to donate)
			 - Deactivating (high EN and induce positive phenol)
		 4. Carbonyls and Others (Positive Inductive):  
